...
#define STRING_CONFIG_H_AUTHOR "(thisiskeithb, Ender-3 Pro With SKR MINI E3 v1.2)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 Pro SKR Mini"
 ...
 *
 */
#define Z_MIN_PROBE_PIN PC14 // Pin 32 is the RAMPS default, set to Probe pin for installed type
